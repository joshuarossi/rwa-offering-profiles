...
overview:{
  ...
  body:[
    ...
    'Note holders receive 85% of distributable cash flow, paid quarterly in EUR or USDC, with the balance retained by the sponsor as a subordinated interest. Notes amortise from year 6 and mature in 2041, matching the PPA term.'
  ],
...
perf:{
  ...
  label:'HELX Fair Value (EUR / token)',note:'Illustrative series for demonstration. Fair value is estimated monthly by the calculation agent using a discounted cash flow of contracted PPA revenue. Past performance does not indicate future results.',
  metrics:[
...
calc:{min:1000,max:1000000,default:20000,price:50,feePct:0.75,tokenDecimals:0,unitTitle:'Capacity equivalent',yieldTitle:'Projected annual distribution (7.4%)',note:'Par €50.00 per note. Amounts shown in EUR-equivalent at 1:1 for illustration.',
...
faq:[
  ...
  ['Is there currency risk?','The plant earns euros and distributions are in EUR or USDC at the prevailing rate on the payment date. Investors whose base currency is not EUR bear exchange-rate risk.'],
],
risks:[
  ...
  ['Currency risk','Distributions are denominated in EUR. Investors in other currencies bear exchange-rate movements.'],
],
